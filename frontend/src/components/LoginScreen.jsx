...
import { getLoginUrl, loginAsGuest, setToken } from '../services/api'
      ...
      <div className="relative z-10 flex flex-col items-center gap-10 max-w-md w-full px-6">
        ...
        <div className="w-full glass-panel p-8 flex flex-col gap-6">
          ...
          <div className="flex items-center gap-4 w-full">
            <div className="h-px bg-panel-border flex-1"></div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 bg-white/5 border border-panel-border hover:bg-white/10 hover:border-white/20 text-white font-medium py-3.5 px-6 rounded-xl transition-all duration-300 disabled:opacity-50 cursor-pointer"
          >
            {isLoggingInGuest ? "Loading..." : "Try a Sample Document"}
          </button>
        </div>
